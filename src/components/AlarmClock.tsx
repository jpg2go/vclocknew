      ...
      >
        ...
        <div className={isFullscreen ? '' : 'mt-4'}>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mt-4">
            <button onClick={startTimer} className="px-6 sm:px-8 py-2 sm:py-3 rounded-md font-medium text-white transition-colors shadow-sm bg-green-500 hover:bg-green-600 text-sm sm:text-base" disabled={isRunning}>Start</button>
            <button onClick={pauseTimer} className="px-6 sm:px-8 py-2 sm:py-3 rounded-md font-medium bg-yellow-400 hover:bg-yellow-500 text-white transition-colors shadow-sm text-sm sm:text-base" disabled={!isRunning}>Pause</button>
            <button onClick={resetTimer} className="px-6 sm:px-8 py-2 sm:py-3 rounded-md font-medium bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 transition-colors shadow-sm text-sm sm:text-base">Reset</button>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-black rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
            <h3 className="text-sm sm:text-base lg:text-lg font-medium text-gray-800 dark:text-white">Quick Timer Presets</h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {currentTimers.map((timer, index) => (
              <button
                ...
                className="px-3 py-2 text-xs sm:text-sm rounded transition-colors bg-blue-500 dark:bg-blue-600 text-white hover:bg-blue-600 dark:hover:bg-blue-700"
              >
                {timer.label}
              </button>
            ))}
